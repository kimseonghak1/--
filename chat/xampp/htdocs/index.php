	...
	<script>
		...
		function connect() {  //웹소켓에 연결
				...
				websocket.onclose = function(e) {
					let data = {"code":"close", "user_id":MY_USER_ID};
...
/*								element.name
				...
				function sendMyName(sending_user_name) {
					...
					$("#divPannel").html(`<input type=text id="txtMessage" value="" placeholder="보낼 메시지를 입력하세요" style="font-size:18px; width:320px" onkeypress="javascript:if(event.keyCode==13){sendMessage();return false;};return true;"> 
